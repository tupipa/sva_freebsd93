...
# $FreeBSD: releng/9.3/release/powerpc/generate-hfs.sh 221465 2011-05-04 23:34:10Z nwhitehorn $
...
echo '$FreeBSD: releng/9.3/release/powerpc/generate-hfs.sh 221465 2011-05-04 23:34:10Z nwhitehorn $' >> $OUTPUT_FILE.bz2.uu
