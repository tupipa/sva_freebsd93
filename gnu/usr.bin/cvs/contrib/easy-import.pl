...
#
# $FreeBSD: releng/9.3/gnu/usr.bin/cvs/contrib/easy-import.pl 50966 1999-09-05 17:35:31Z peter $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: releng/9.3/gnu/usr.bin/cvs/contrib/easy-import.pl 50966 1999-09-05 17:35:31Z peter $' . "\n"; # 'emacs kludge
	exit 0;
    }
